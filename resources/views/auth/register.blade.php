            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="registerForm" class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('weight') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('group') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Groupe sanguaine</label>
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Confirmer Password</label>
                    ...
                    <div class="form-group{{ $errors->has('is_donor') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Donneur</label>
                         ...
                         <div class="form-group{{ $errors->has('last_donated') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Dernier don le</label>
