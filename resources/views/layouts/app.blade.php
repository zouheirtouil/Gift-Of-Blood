...
<head>
    ...
    <style> .nav-style { border-right: 0px; border-left: 0px;border-top: 0px;text-decoration-color: red;}</style>
    ...
    <nav class="header-nav navbar navbar-default nav-style">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                  <img class="logo" src="{{ url('images/imageedit_10_7543610327.png') }}">
            ...
            <div class="collapse navbar-collapse" id="spark-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="{{ url('/donors') }}">Donneurs</a></li>
                    <li><a href="{{ url('/camp') }}">Hopitaux</a></li>
                    <li><a href="{{ url('/center') }}">Centres du don</a></li>
                    <li><a href="{{ url('/request-blood') }}">Demande du sang</a></li>
                    <li><a href="{{ url('/request-blood') }}">Cas urgent</a></li>
